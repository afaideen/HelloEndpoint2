...
package com.birdpeek.helloendpoint.helloworld;
...
public class Helloworld extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://2-dot-playchat-53073.appspot.com/_ah/api/";
  ...
  public class Greetings {
    ...
    public class Authed extends HelloworldRequest<HelloGreeting> {
       ...
       */
      protected Authed() {
        super(Helloworld.this, "POST", REST_PATH, null, HelloGreeting.class);
      }
    ...
    public class GetGreeting extends HelloworldRequest<HelloGreeting> {
      ...
      protected GetGreeting(java.lang.Integer id) {
        super(Helloworld.this, "GET", REST_PATH, null, HelloGreeting.class);
    ...
    public class ListGreeting extends HelloworldRequest<HelloGreetingCollection> {
      ...
      protected ListGreeting() {
        super(Helloworld.this, "GET", REST_PATH, null, HelloGreetingCollection.class);
      }
     ...
     *
     * @param times
     * @param content the {@link HelloGreeting}
     * @return the request
     */
    public Multiply multiply(java.lang.Integer times, HelloGreeting content) throws java.io.IOException {
      Multiply result = new Multiply(times, content);
      initialize(result);
      return result;
    }

    public class Multiply extends HelloworldRequest<HelloGreeting> {
       ...
       * @since 1.13
       */
      protected Multiply(java.lang.Integer times, HelloGreeting content) {
        super(Helloworld.this, "POST", REST_PATH, content, HelloGreeting.class);
